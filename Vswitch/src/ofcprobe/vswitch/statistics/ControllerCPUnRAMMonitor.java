...
import ofcprobe.vswitch.statistics.snmp.SNMPManager;
...
public class ControllerCPUnRAMMonitor implements IStatistics {
	...
	public ControllerCPUnRAMMonitor(Config config){
		this.cpuValues = new ArrayList<Double>();
		this.ramUsedValues = new ArrayList<Double>();
		this.ramFreeValues = new ArrayList<Double>();
	...
	/**
	 * Method thougt to check if there is SNMP Server running on provided IP
