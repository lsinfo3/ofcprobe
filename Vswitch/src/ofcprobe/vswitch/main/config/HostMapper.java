...
import ofcprobe.vswitch.trafficgen.ipgen.IIpGenerator;
import ofcprobe.vswitch.trafficgen.ipgen.SerialIPGenerator;
import ofcprobe.vswitch.trafficgen.macgen.IMacGen;
import ofcprobe.vswitch.trafficgen.macgen.SerialMacGen;
...
public class HostMapper {
	...
	/**
	 * Fills the MAPs with Items, so every ofSwitch with freePorts gets an IP/MAC for a faked "HOST"
...
//		System.err.println(deviceToIP);
//		System.err.println(ipToDevice);
//		System.err.println(deviceToMac);
//		System.err.println(macToDevice);
//		System.err.println(macIPmap);
	...
	public List<String> getTargetsForIP(String srcIP) {
		Set<java.lang.String> targetIPs = new HashSet<java.lang.String>(this.macIPmap.inverse().keySet());
		targetIPs.remove(srcIP);
		
		return new ArrayList<String>(targetIPs);
	}
