 ...
 * Containing helper Methods that are used over and over again
...
public class Util {
	 ...
	 *            the source array
	 * @param pos
	 *            starting position of the target array
	 ...
	 *            the target array
	 * @param value
	 *            the long to insert into the array.
	 * @param pos
	 *            starting position of the target array.
	 * @param cnt
...
//    -------------
	...
	/**
	 * Computes the seconds between two Dates
	 * needed for Statistics Methods to determine where to put processsed Packet
   ...
   /**
    * Ensure that a ArrayList has the provided size
    * Needed for enhance ArrayList.add(index, item)
    * @param list the List
