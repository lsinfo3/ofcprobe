...
public class Topology {
	...
	/**
	 * The Topology Matrix
	 * first Dimension: Source Switch
	 * Second Dimension: Target Switch
	 * [1][2]=5 --> switch 1 is connected to switch2 on switch2's port 5
	 */
	...
	/**
	 * Gets the DPID of the connected Switch for the Connection dpid:localPort -> TargetDPID
	...
	public List<Long> getConnectedOfSwitches(long ofSwitchDpid) {
		...
		List<Long> connectedOfSwitches = new ArrayList<Long>();
		if (ofSwitch <= this.countSwitches) {
	...
	/**
	 * Prints Topology to Nice Format:
	 * ofSwitch1:Port==ofSwitch2:Port
	 */
	...
	/**
	 * Gets the List of Portnumbers of Ports which are not connected toanother Port of Switch with dpid
